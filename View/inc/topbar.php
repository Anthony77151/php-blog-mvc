	...
	<nav class="#212121 grey darken-4">
		<div class="container">
			<div class="nav-wrapper">
				...
				<a href="<?= ROOT_URL ?>blog_index.html" class="brand-logo titresite">Jean Forteroche</a>
				...
				<ul class="right hide-on-med-and-down">
					...
					<?php if (empty($_SESSION['is_admin']) && empty($_SESSION['is_user'])) : ?>
						<li><a href="<?= ROOT_URL ?>blog_login.html" class="btn orange lighten-3
 black-text waves-effect waves-light">Connexion<i class="material-icons right">lock_open</i></a></li>
					<?php endif ?>
					...
					<?php if (!empty($_SESSION['is_admin']) || !empty($_SESSION['is_user'])) : ?>
						<li><a href="<?= ROOT_URL ?>?p=blog&amp;a=logout" class="btn orange lighten-3
 black-text waves-effect waves-light">Déconnexion<i class="material-icons right">lock_outline</i></a></li>
					<?php endif ?>
				</ul>
