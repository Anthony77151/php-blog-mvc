		...
		<div class="container">
			<div class="nav-wrapper">
				...
				<ul class="right hide-on-med-and-down">
					...
					<li><a href="<?=ROOT_URL?>blog_login.html" class="btn deep-purple darken-3 waves-effect waves-light">Connexion<i class="material-icons right">lock_open</i></a></li>
					<?php endif ?>
					...
					<?php if (!empty($_SESSION['is_admin']) || !empty($_SESSION['is_user'])): ?>
					<li><a href="<?=ROOT_URL?>?p=blog&amp;a=logout" class="btn deep-purple darken-3 waves-effect waves-light">Déconnexion<i class="material-icons right">lock_outline</i></a></li>
					<?php endif ?>
				</ul>
