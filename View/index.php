...
<main>
  <div class="container">
    ...
    <?php else: ?>
    <h1 class="page-title white-text">Billet simple pour l'Alaska</h1>
    <div class="row">
        ...
        <div class="col l6 m6 s12">
          <div class="card hoverable">
            ...
            <div class="card-content">
              ...
              <p><a class="black-text" href="<?=ROOT_URL?>blog_post_<?=$oPost->id?>.html">Voir le chapitre au complet</a></p>
            </div>
